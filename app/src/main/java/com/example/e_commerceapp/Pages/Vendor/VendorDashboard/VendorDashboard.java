...
public class VendorDashboard extends AppCompatActivity {
    ...
    VendorDashboardAdapter vendorDashboardAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.recycle_vendor_dashboard);
        bgimg=findViewById(R.id.vendor_dashboard_img);
        ...
        restCall.getOrder("get_order",preferenceManager.getVendorId())
                ...
                .subscribe(new Subscriber<Getorder_Response>() {
                    ...
                    public void onError(Throwable e) {
                        Toast.makeText(VendorDashboard.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onNext(Getorder_Response getorderResponse) {
                        if (getorderResponse.getStatus().equalsIgnoreCase(VariableBag.SUCCESS_CODE)){
                            ...
                            vendorDashboardAdapter=new VendorDashboardAdapter(VendorDashboard.this,cartItems,totalQuantity,totalAmount);
                            recyclerView.setAdapter(vendorDashboardAdapter);
                        }
                        else {
                            bgimg.setVisibility(View.VISIBLE);
                            Toast.makeText(VendorDashboard.this, getorderResponse.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
